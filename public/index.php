...
$router->get('/admin/settings/shipping/localitati/export', [AdminController::class, 'shippingLocalitatiExport']);
...
$router->post('/admin/emails/history/resend', [AdminController::class, 'emailsHistoryResend']);
