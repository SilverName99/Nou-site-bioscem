...
final class AdminController
{
    ...
    public function productTemplateBuilder(array $params = []): void
    {
        ...
        $availablePlaceholders = [
            ...
            ['code' => '{{product_taxonomii}}', 'label' => 'Marcă + etichete (bloc gata făcut)'],
            ['code' => '{{product_brand}}', 'label' => 'Marcă (text)'],
            ['code' => '{{product_brand_link}}', 'label' => 'Marcă (link către pagina mărcii)'],
            ['code' => '{{product_brand_url}}', 'label' => 'URL pagina mărcii'],
            ['code' => '{{product_tags}}', 'label' => 'Etichete (linkuri)'],
            ['code' => '{{product_tags_text}}', 'label' => 'Etichete (text, separate prin virgulă)'],
    ...
    public function emailsSave(): void
    {
        ...
        $payload = [
            ...
            'order_email_from_name' => trim((string) ($_POST['order_email_from_name'] ?? 'Bioscem')),
